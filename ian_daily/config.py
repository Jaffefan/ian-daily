...
PODCAST_TARGET_CHARS = int(os.environ.get("IAN_DAILY_PODCAST_TARGET_CHARS", "4000"))
PODCAST_MIN_CHARS = int(os.environ.get("IAN_DAILY_PODCAST_MIN_CHARS", "3600"))
PODCAST_MAX_CHARS = int(os.environ.get("IAN_DAILY_PODCAST_MAX_CHARS", "4400"))
MIN_AUDIO_DURATION_SEC = float(os.environ.get("IAN_DAILY_MIN_AUDIO_DURATION_SEC", "420"))
MAX_AUDIO_DURATION_SEC = float(os.environ.get("IAN_DAILY_MAX_AUDIO_DURATION_SEC", "960"))
...
MODEL_CALL_ALERT_LIMIT_PER_CATEGORY = int(os.environ.get("IAN_DAILY_MODEL_CALL_ALERT_LIMIT_PER_CATEGORY", "24"))
